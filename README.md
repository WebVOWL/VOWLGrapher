...
- Fetch and visualize data from external SPARQL endpoints (work in progress)
...
| Ontology      | Triples   | FPS (WebVOWL) |  Load (s)   | Mem. (MB) | FPS (VOWLGrapher) | Load (s) | Mem. (MB) |
| :------------ | :-------- | :-----------: | :---------: | :-------: | :---------------: | :------: | :-------: |
...
4. Run `cargo install --locked cargo-leptos --version 0.3.8`
